...
import { View, StyleSheet, KeyboardAvoidingView, ActivityIndicator, Alert, Platform, ScrollView } from 'react-native';
...
const EditCreateScreen = (props) => {
	...
	const submitHandler = useCallback(
		async () => {
			...
			try {
				if (editedProperty) {
					console.log(`This is editedProperty in try/catch ${JSON.stringify(editedProperty)}`);
					await dispatch(
						propertyActions.editedProperty(
							propID,
